...
This project is created using Python, Jinja, HTML, CSS, JavaScript and Flask. Root directory is named "project" and it contains the following files and folders:
