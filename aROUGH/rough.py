...
def update_output_container(selected_statistics, input_year):
    if selected_statistics == 'Recession Period Statistics':
        ...
        R_chart3 = dcc.Graph(
            figure=px.pie(exp_rec,
                ...
                names='Vehicle_Type',
                title="Sales Distribution by Vehicle Type During Recession"))
    ...
    # Check for Yearly Statistics.
        ...
        mas=data.groupby('Month', sort=False)['Automobile_Sales'].sum().reset_index()
        Y_chart2 = dcc.Graph(
            figure=px.line(mas,
                x='Month',
                y='Automobile_Sales',
        ...
        Y_chart3 = dcc.Graph(
            figure=px.bar(avr_vdata,
                x='Vehicle_Type',
                y='Automobile_Sales',
                title='Average Vehicles Sold by Vehicle Type in the year {year}'.format(year=input_year)))
