...
Finally when changed the dimension of filters to (6, 6) then it had drastic effect on accuracy. Also making the dropout equal to 0.25 also helped in accuracy increasing further, though not very significantly
