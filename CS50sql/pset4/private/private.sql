...
WHERE id = 14
UNION
SELECT TRIM(substr("sentence", 3, 5))
FROM "sentences"
WHERE id = 114
UNION
SELECT TRIM(substr("sentence", 72, 9))
FROM "sentences"
WHERE id = 618
UNION
SELECT TRIM(substr("sentence", 7, 3))
FROM "sentences"
WHERE id = 630
UNION
SELECT TRIM(substr("sentence", 12, 5))
FROM "sentences"
WHERE id = 932
UNION
SELECT TRIM(substr("sentence", 50, 7))
FROM "sentences"
WHERE id = 2230
UNION
SELECT TRIM(substr("sentence", 44, 10))
FROM "sentences"
WHERE id = 2346
UNION
