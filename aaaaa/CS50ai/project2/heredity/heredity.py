...
def update(probabilities, one_gene, two_genes, have_trait, p):
    ...
    # Loop through each person in one_gene
    for person in probabilities:

        # Add to one-gene probability
        if person in one_gene:
            probabilities[person]['gene'][1] += p
        # Add to two-gene probability
        elif person in two_genes:
            probabilities[person]['gene'][2] += p
        # Add to 0-gene probaility
        else:
...
def normalize(probabilities):
    ...
    for person in probabilities:
        ...
        total_pb = probabilities[person]['gene'][0] + \
            probabilities[person]['gene'][1] + probabilities[person]['gene'][2]
        probabilities[person]['gene'][0] /= total_pb
        probabilities[person]['gene'][1] /= total_pb
        probabilities[person]['gene'][2] /= total_pb

        # Normalize trait probabilities
        total_pb = probabilities[person]['trait'][True] + probabilities[person]['trait'][False]
        probabilities[person]['trait'][True] /= total_pb
        probabilities[person]['trait'][False] /= total_pb
